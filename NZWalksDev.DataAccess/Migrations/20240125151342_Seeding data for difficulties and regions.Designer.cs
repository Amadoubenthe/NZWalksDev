...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NZWalksDev.DataAccess.Models.Domain.Difficulty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("db39f272-0bdf-4d41-baa5-d9727c249aae"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("cb99619e-6eca-45ea-bd61-10e111c92c12"),
                            Name = "Hard"
                        });
                });

            modelBuilder.Entity("NZWalksDev.DataAccess.Models.Domain.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalksDev.DataAccess.Models.Domain.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalksDev.DataAccess.Models.Domain.Walk", b =>
                {
                    b.HasOne("NZWalksDev.DataAccess.Models.Domain.Difficulty", "Difficulty")
                        .WithMany()
                        .HasForeignKey("DifficultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NZWalksDev.DataAccess.Models.Domain.Region", "Region")
                        .WithMany()
